 	...
 	<div style="float：left;width:660px;">
 		<s:if test="#session.usero.ulimit==0">
 	 	...
 	 	<s:else>
		   ...
		   <input type="button" id="addsig" onclick="addClickEventListener()" value="添加信号机" style="margin-left:20px;margin-top:10px;width:100px;height:20px; background:url(images/topbtn02.fw.png); color:#FFF; border-bottom:#039 1px solid; border-right:#039 1px solid;"/>&nbsp;&nbsp;
			<input type="button" id="delsig" onclick="deleteSig()" value="删除信号机" style="margin-left:20px;margin-top:10px;width:100px;height:20px; background:url(images/topbtn02.fw.png); color:#FFF; border-bottom:#039 1px solid; border-right:#039 1px solid;"/>
 	 </div>
