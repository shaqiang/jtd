					...
					<ul class="forminfo">
						...
						<li>
							<div style="float: left; line-height: 35px;">
								...
								<div class="vocation">
									<s:textfield name="opevent"  cssClass="dfinput" cssStyle="width:200px;"/>
								</div>
								<b>*</b>
							</div>
						</li>
						...
						<table width="98%" border="0" align="center" cellpadding="2"
							...
							<tr align="right" bgcolor="#EEF4EA">
								...
								<td height="34" colspan="6" align="center" bgcolor="#FFFFFF">
									...
									<a
										href="javascript:jumpOplogPage('oplogAction!list',<s:property value="1"/>,<s:property value="uid"/>,'<s:property value="opevent"/>','<s:property value="startdate"/>','<s:property value="enddate"/>');"
										target="main">首页</a>&nbsp;&nbsp;
									<a
										href="javascript:jumpOplogPage('oplogAction!list',<s:property value="page-1"/>,<s:property value="uid"/>,'<s:property value="opevent"/>','<s:property value="startdate"/>','<s:property value="enddate"/>');"
										target="main">上一页</a>&nbsp;&nbsp;&nbsp;
									<a
										href="javascript:jumpOplogPage('oplogAction!list',<s:property value="page+1"/>,<s:property value="uid"/>,'<s:property value="opevent"/>','<s:property value="startdate"/>','<s:property value="enddate"/>');"
										target="main">下一页</a>&nbsp;&nbsp;&nbsp;
									<a
										href="javascript:jumpOplogPage('oplogAction!list',<s:property value="pageCount"/>,<s:property value="uid"/>,'<s:property value="opevent"/>','<s:property value="startdate"/>','<s:property value="enddate"/>');"
										target="main">尾页</a>&nbsp;&nbsp;&nbsp;
									<input type='button' class="exit"
										onclick="jumpOplogPage('oplogAction!list',document.getElementById('page').value,<s:property value="uid"/>,'<s:property value="opevent"/>','<s:property value="startdate"/>','<s:property value="enddate"/>');"
										value='转到' />
									&nbsp; 当前页：
